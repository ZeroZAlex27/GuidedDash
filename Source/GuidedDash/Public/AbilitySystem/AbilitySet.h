...
public:
	...
	TSubclassOf<UGuidedGameplayAbility> Ability = nullptr;
...
public:
	...
	void TakeFromAbilitySystem(UGuidedAbilitySystemComponent* ASC);
...
class GUIDEDDASH_API UAbilitySet : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	void GiveToAbilitySystem(UGuidedAbilitySystemComponent* ASC, FAbilitySet_GrantedHandles* OutGrantedHandles, UObject* SourceObject = nullptr) const;
