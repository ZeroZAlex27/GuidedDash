 ...
 */
UCLASS()
class GUIDEDDASH_API UGamePhaseSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
	
public:
	void StartPhase(TSubclassOf<UGamePhaseAbility> PhaseAbility, FGamePhaseDelegate PhaseEndedCallback = FGamePhaseDelegate());
...
protected:
	...
	void K2_StartPhase(TSubclassOf<UGamePhaseAbility> Phase, const FGamePhaseDynamicDelegate& PhaseEnded);
