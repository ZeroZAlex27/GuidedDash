...
*/
UCLASS()
class GUIDEDDASH_API UAsyncAction_ObserveTeam : public UCancellableAsyncAction
{
	GENERATED_BODY()
...
private:
	...
	static UAsyncAction_ObserveTeam* InternalObserveTeamChanges(TScriptInterface<ITeamAgentInterface> TeamActor);
