...
#include "GuidedCharacter.generated.h"
 ...
 *	AGuidedCharacter
 *
 *	The base character class used by this project.
 */
UCLASS(Config = Game, Meta = (ShortTooltip = "The base character class used by this project."))
class GUIDEDDASH_API AGuidedCharacter : public ACharacter, public IAbilitySystemInterface, public IGameplayCueInterface, public IGameplayTagAssetInterface, public ITeamAgentInterface
{
	GENERATED_BODY()

public:
	AGuidedCharacter(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "Guided|Character")
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, Category = "Guided|Character")
	TObjectPtr<const UPawnData> PawnData;

private:
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Guided|Character", Meta = (AllowPrivateAccess = "true"))
