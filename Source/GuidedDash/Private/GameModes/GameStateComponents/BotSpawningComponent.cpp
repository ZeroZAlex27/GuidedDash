...
#include UE_INLINE_GENERATED_CPP_BY_NAME(BotSpawningComponent)

#if WITH_SERVER_CODE

void UBotSpawningComponent::ServerCreateBots()
{
...
FString UBotSpawningComponent::CreateBotName(int32 PlayerIndex)
{
	FString Result;
...
void UBotSpawningComponent::SpawnOneBot()
{
	...
	{
		if (AGuidedGameMode* GameMode = Cast<AGuidedGameMode>(GetWorld()->GetAuthGameMode()))
		{
...
void UBotSpawningComponent::RemoveOneBot()
{
